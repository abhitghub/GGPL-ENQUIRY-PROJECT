...
_FIELD_SCHEMA = """{
  ...
  "isk_style": "STYLE-CS | STYLE-N | TYPE-A | TYPE-E | TYPE-F | TYPE-D | VCS | null",
  "isk_type": "TYPE-E | TYPE-F | TYPE-D | null",
  "isk_fire_safety": "FIRE SAFE | NON FIRE SAFE | null",
  "isk_gasket_material": "GRE G10 | GRE G11 | PTFE | PEEK | Mica | G7 | null",
  "isk_core_material": "metal core e.g. SS316 | CS | DUPLEX | UNS S32760 | INC 625 | null",
  "isk_sleeve_material": "sleeve material e.g. GRE G10 | PTFE | Mylar | null",
  "isk_washer_material": "metallic washer e.g. Zinc Plated CS | SS316 | MS | null",
  "isk_primary_seal": "Viton O-ring | PTFE Spring Energised | Graphite | EPDM O-ring | null",
  "isk_secondary_seal": "Mica | Graphite | null",
  "isk_insulating_washer": "insulating washer grade e.g. G10 | G11 | Mica | Mylar | null",
  "dji_filler": "filler material or null",
  "dji_rib": "WITH RIB | WITHOUT RIB | null",
  "dji_face_type": "RF | FF | null",
  "dji_id_first": "true if ID dimension appears before OD in description | false",
  "kamm_core_material": "KAMM metal core e.g. SS316 | CS | ALLOY 625 | null",
  "kamm_surface_material": "KAMM surface e.g. GRAPHITE | PTFE | MICA | null",
  "kamm_covering_layer": "GRAPHITE | PTFE | MICA | NON ASBESTOS | null",
  "kamm_rib": "WITH RIB | WITHOUT RIB | null",
  "kamm_core_thk": "core thickness mm as number | null",
...
_ALL_FIELDS = [
    ...
    'isk_style', 'isk_type', 'isk_fire_safety',
    ...
    'kamm_covering_layer', 'kamm_rib', 'kamm_core_thk', 'kamm_integral_outer_ring',
