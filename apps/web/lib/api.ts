...
export const GRANULAR_ENQUIRY_WORKFLOW_ACTIONS = [
  ...
  { action: "send_to_technical_review", from: ["combined_spec_review"], roles: ["estimation"], label: "Send for technical check (optional)" },
  { action: "return_tr_spec", from: ["technical_review_pending"], roles: ["technical"], label: "Technical check done" },
