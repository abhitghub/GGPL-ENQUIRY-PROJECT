...
from ui.material_plan import render_material_plan_section
...
with tab_manual:
    ...
    if submitted:
        if not (m_size or m_moc):
            ...
            st.session_state.pop('_material_plan', None)
...
if st.session_state.working_items:
    ...
    render_material_plan_section(items)
    ...
    <div class="gq-step" style="border-left-color:#1a7a3c">
      <div class="gq-step-label">
        <span class="gq-step-badge" style="background:#1a7a3c">4</span>
